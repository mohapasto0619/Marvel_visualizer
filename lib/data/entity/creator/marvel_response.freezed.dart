...
CreatorMarvelResponse _$CreatorMarvelResponseFromJson(
    Map<String, dynamic> json) {
  return _MarvelResponse.fromJson(json);
}

/// @nodoc
mixin _$CreatorMarvelResponse {
  ...
  @JsonKey(ignore: true)
  $CreatorMarvelResponseCopyWith<CreatorMarvelResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CreatorMarvelResponseCopyWith<$Res> {
  factory $CreatorMarvelResponseCopyWith(CreatorMarvelResponse value,
          $Res Function(CreatorMarvelResponse) then) =
      _$CreatorMarvelResponseCopyWithImpl<$Res, CreatorMarvelResponse>;
  @useResult
  $Res call(
      {int? code,
      String? status,
...
/// @nodoc
class _$CreatorMarvelResponseCopyWithImpl<$Res,
        $Val extends CreatorMarvelResponse>
    implements $CreatorMarvelResponseCopyWith<$Res> {
  _$CreatorMarvelResponseCopyWithImpl(this._value, this._then);
...
class __$$_MarvelResponseCopyWithImpl<$Res>
    extends _$CreatorMarvelResponseCopyWithImpl<$Res, _$_MarvelResponse>
...
class _$_MarvelResponse implements _MarvelResponse {
  ...
  @override
  String toString() {
    return 'CreatorMarvelResponse(code: $code, status: $status, copyright: $copyright, attributionText: $attributionText, attributionHtml: $attributionHtml, etag: $etag, data: $data)';
  }
...
abstract class _MarvelResponse implements CreatorMarvelResponse {
...
class _$_Result implements _Result {
  ...
  @override
  String toString() {
    return 'Result(id: $id, firstName: $firstName, middleName: $middleName, lastName: $lastName, suffix: $suffix, fullName: $fullName, modified: $modified, thumbnail: $thumbnail, resourceUri: $resourceUri, comics: $comics, series: $series, stories: $stories, events: $events, urls: $urls)';
  }
